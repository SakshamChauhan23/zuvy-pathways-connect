...
const Testimonials = () => {
  ...
  return (
    <section id="testimonials" className="py-24 bg-gradient-to-br from-light-beige to-pure-white">
      <div className="container mx-auto px-6">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <Card 
              key={index}
              className="group relative overflow-hidden border-0 shadow-soft hover:shadow-medium transition-all duration-500 hover:-translate-y-2 bg-pure-white"
            >
              ...
              <CardContent className="relative z-10 p-6">
                <div className="flex items-start justify-between mb-4">
                  <Quote className="w-8 h-8 text-moss-green opacity-60" />
                ...
                <div className="border-t border-border pt-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <div className="text-xs font-semibold text-moss-green bg-moss-green/10 px-2 py-1 rounded">
        ...
        <div className="text-center mt-16">
          <div className="inline-block bg-pure-white rounded-3xl p-8 shadow-medium border border-border">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <button className="border border-border text-foreground px-6 py-3 rounded-lg font-semibold hover:bg-muted transition-all duration-300">
                Learn More
              </button>
            </div>
          </div>
